...
from backend.models import db, Patient, Trio, VariantUpload, VariantAuditLog
...
def upload_trio_xlsx(patient_id):
    ...
    mismatch_error = variant_upload_id_mismatch_message(f, patient, expect_trio=True)
    if mismatch_error:
